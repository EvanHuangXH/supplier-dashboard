...
export default async function handler(req, res) {
  ...
  const { q, category, supplier_id, shipping_country, product_type, min_price, max_price, shipping_from, date_from, date_to, is_hot, is_new, sort = 'first_seen_at_desc', page = 1, limit = 20 } = req.query;
  ...
  const [sortCol, sortOpts] = sortMap[sort] || sortMap.first_seen_at_desc;
