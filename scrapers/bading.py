"""Scraper for 八点多 (8ding.com) — standard 8ding platform."""
import sys, os, re
...
def parse_product_card(card, category_name=None):
    ...
    return {
        ...
        "product_url": product_url, "raw": {"supplier": "八点多"},
    }
